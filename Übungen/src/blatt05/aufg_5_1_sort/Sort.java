...
public class Sort {
	...
	/**
	 * Quicksort
	 * (Version according to books of Saake/Sattler and
	...
	/** (= aufteilen)
	 *  selects a pivot value and splits values of a[low..high] into two parts so that
	 *  at the end 
	 *  - ppos is the position of the pivot element 
	 *  - all values from a[low..ppos-1] are less or equal to the pivot element
	 *  - all values from a[ppos-1..high] are greater than the pivot element
	 */
	...
	/**
	 * Transform array contents into a max-heap (= erstelleMaxHeap)
	 */
	...
	/**
	 * Integrate a[i] into the heap area a[i+1..m]  (= versenke)
